...
public class AddAttendanceSessionActivity extends AppCompatActivity {
    ...
    private final String[] branchString = new String[]{"MCA","MBA"};
    private final String[] SemString = new String[]{"1st", "2nd"};
    private final String[] subjectFinal = new String[]{"DS", "PYTHON", "ST", "CN"};
